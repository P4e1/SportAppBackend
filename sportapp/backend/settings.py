...
ALLOWED_HOSTS = ['*']  # или ['10.0.2.2', 'localhost', '127.0.0.1']


AUTH_USER_MODEL = 'sportapp.Users'
...
ACCOUNT_EMAIL_VERIFICATION = 'none'  # или 'mandatory', если хочешь email-подтверждение
...
CORS_ALLOW_ALL_ORIGINS = True  # или явно указать домены

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'sportapp/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
